...
//         cubie.position = new Vector3(
//           cubie.position!.x,
//           Math.round(matrix.elements[6]) * cubieSize,
//           Math.round(matrix.elements[7]) * cubieSize
//         );
//         cubie.rotation = new Quaternion(
